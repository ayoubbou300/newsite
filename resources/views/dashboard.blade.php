            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <div style="display:flex">
                    ...
                    <div style="background: #FFFFFF; box-shadow: 4px 8px 16px rgba(0, 0, 0, 0.05); border-radius: 8px; width:290px ;margin:30px;">
                        ...
                        <h6 style="font-style: normal;  font-weight: 400;  font-size: 10px; line-height: 120%; text-transform: uppercase; width: 12rem;width: 400, Regular; size: 10px;color: #A5AABB;margin: 20px;"></h6> 
                        <h1 style=" font-family: 'Montserrat', sans-serif ;  font-style: normal;  font-weight: 550;  font-size: 16px; line-height: 120%; color: #1D2B56;margin: 20px;"></h1>
                        <p style="font-family: 'Montserrat', sans-serif; font-style: normal;text-align: center;  font-weight: 300; font-size: 10px; line-height: 150%; color: #A5AABB;  width: 226px;margin: 20px;"></p>
